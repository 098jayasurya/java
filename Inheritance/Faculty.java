...
public class Faculty extends Person {
    ...
    public Faculty(String name,double height,double weight,int eno,String dept,String subject,double sal){
    ...
    public void prepareMaterial(){
        System.out.println(getName() +"is preparintg"+subject+" material");
    }
